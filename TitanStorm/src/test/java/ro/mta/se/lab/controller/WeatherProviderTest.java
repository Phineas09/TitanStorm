...
/**
 * Test class for WeatherProvider, it will Mock the WeatherRequest object and Spy the logger
 */
@RunWith(MockitoJUnitRunner.class)
public class WeatherProviderTest {

    /** Static api response example as a string */
    ...
    /** Injecting Mocks into the targeted object  */
    @InjectMocks
    ...
    @Test
    public void testGetWeekForecast() {
        assertEquals(weatherProvider.getWeekForecast(city), responseJson);
    }

    /**
     * Tests the parsed response from api it's ok, the Model is tested
     * check for logging as requested by the api doc, every http call is logged.
     */
    @Test
    ...
    /**
     * Test the converter method to be accurate with one decimal
     */
    @Test
    public void testConvertToF() {
    ...
    /**
     * Assert that the list expected to be returned it's ok, has the good number of elements
     * and all elements are not null
     */
    @Test
